...
async def handle_request(request: Request):
    ...
    #Extract the neccessary information from the payload
    #based on the structure of the Webhook Request form Dialogflow
...
def add_to_order(parameters:dict,session_id:str):
    ...
    if len(food_items) != len(quantities):
        ...
        fulfillment_text = f"So fat you have : {order_str}. Do you need anything else?"
...
def complete_order(parameters:dict,session_id:str):
    if session_id not in inprogress_orders:
        ...
        if order_id == -1:
            fulfillment_text = "Sorry, I couldn't process your order due to a backend serror ." \
